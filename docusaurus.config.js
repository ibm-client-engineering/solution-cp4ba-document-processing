...
async function createconfig() {
  ...
  const config = {
    ...
    baseUrl: "/solution-cp4ba-document-processing/",


    // GitHub pages deployment config.
    // If you aren"t using GitHub pages, you don"t need these.
    organizationName: "ibm-client-engineering", // Usually your GitHub org/user name.
    projectName: "solution-cp4ba-document-processing", // Usually your repo name.
      ...
      [
        ...
        ({
          docs: {
            ...
            editUrl:
              "https://github.com/ibm-client-engineering/solution-cp4ba-document-processing/tree/main/packages/create-docusaurus/templates/shared/",
          },
          theme: {
          ...
          blog: {
            ...
            editUrl: ({ locale, blogDirPath, blogPath, permalink }) =>
              ...
              "https://github.com/ibm-client-engineering/solution-cp4ba-document-processing/edit/main/${blogDirPath}/${blogPath}",
      ...
      ({
        ...
        navbar: {
          ...
          items: [
            ...
            {
              href: "https://github.com/ibm-client-engineering/solution-cp4ba-document-processing",
            },
          ],
        },
        footer: {
