...
:::danger
All files in the input directory folder will be sent to ADP. You must make a new folder or use an existing folder that only contains the documents you want sent to ADP.
:::